class Presentacion {
  ...
  mostrar() {
    ...
    /*if (this.estado.estado === 0) {
      this.imagen.mostrar(0, 0);
    } else if (this.estado.estado === 5) {
      this.imagen.cambiarImagen(1);
      this.imagen.mostrar(0, 0);
    } else if (this.estado.estado === 2) {
      this.imagen.cambiarImagen(2);
      this.imagen.mostrar(0,0);
    } else if (this.estado.estado === 2) {
      this.imagen.cambiarImagen(3);
      this.imagen.mostrar(0,0);
    }*/
  ...
  //estado en el que esta el juego
  enestado7() {
  ...
  verificarFinal() {
    if (this.enestado7() && this.juego.juegoTerminado) {
      noLoop();
    }
  }
}
